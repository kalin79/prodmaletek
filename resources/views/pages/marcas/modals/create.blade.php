...
<div class="main-card mb-3 card">
    ...
    <form action="{{ route('marca.store') }}" method="POST" id="form-create-product"
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group">
                                    <label class="field">
                                        ...
                                        <input name="nombre" id="txt_nombre" placeholder="Título" type="text" class="form-control gui-input">
                                    </label>
                            ...
                            <div class="col-md-3">
                                <div class="position-relative form-group">
                                    <label class="field">
                                        ...
                                        <input name="origen_pais" id="origen_pais" placeholder="Origen" type="text" class="form-control gui-input">
                                    </label>
                            ...
                            <div class="col-md-3">
                                <div class="position-relative form-group">
                                    <label class="field">
                                        ...
                                        <input name="anios_en_mercado_mundial" id="anios_en_mercado_mundial"  type="text" class="form-control gui-input">
                                    </label>
                            ...
                            <div class="col-md-3">
                                <div class="position-relative form-group">
                                    <label class="field">
                                        ...
                                        <input name="anios_en_mercado_peru" id="anios_en_mercado_peru"  type="text" class="form-control gui-input">
                                    </label>
                            ...
                            <div class="col-md-3">
                                <div class="position-relative form-group">
                                    <label class="field">
                                        ...
                                        <input name="tallares_oficiales" id="tallares_oficiales"  type="text" class="form-control gui-input">
                                    </label>
                            ...
                            <div class=" col-md-6">
                                ...
                                <label class="field">
                                    <textarea id="descripcion_historia_1" class="form-control form-control-sm gui-input "
                                            ...
                                            placeholder="descripcion_historia_1" ></textarea>
                                </label>
                            </div>
                            ...
                            <div class=" col-md-6">
                                ...
                                <label class="field">
                                    <textarea id="descripcion_historia_2" class="form-control form-control-sm gui-input "
                                            ...
                                            placeholder="descripcion_historia_2" ></textarea>
                                </label>
                            </div>
