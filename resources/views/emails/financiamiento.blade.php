            ...
            <div id="content-mail">
                <div style="width:100%;margin-top: 20px;margin-bottom: 20px;">
                    ...
                    <ul>
                        ...
                        <li><b>Modelo  :</b> {{ $data["producto"] }}</li>
                        ...
                        <li><b>Situacion Laboral  :</b> {{ $data["situacion_laboral"] }}</li>
                        <li><b>Inicial Moto     :</b> S/. {{ $data["cuota_inicial"] }}</li>
                        <li><b>Cuota Mensual :</b> S/. {{ $data["cuota_mensual"] }}</li>
                    </ul>
