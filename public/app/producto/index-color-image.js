$(document).ready(function() {
    ...
    ModalCRUD.create({
        ...
        form_element: '#form-image-create',
...
function activar($id, $url) {
    swal({
            ...
            text: "Estas seguro activar el Imagen",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(dataJson) {
                        if (dataJson.rpt === 1) {
                            swal("Imagen activado correctamente", {
                                    icon: "success",
                                })
                                .then((result) => {
                                    if (result) {
...
function desactivar($id, $url) {
    ...
    swal({
            ...
            text: "Estas seguro desactivar este Imagen",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
...
function load(url = null) {
    ...
    var url = url ? url : url_producto_color_image_load;
